...
### Question: 
*1. What are the measurement units of the `cities_sf3035` object?* - Meters.
...
- Credits and Compas functions are not supported in view mode.
...
### Question: 
*2. Which part of the world are the inscriptions from?* - They are mostly from Italy.
...
### Question: 
*3. Why are we using EPSG 4326 as the value for CRS in the inscriptions? * - It is one of the two most common coordinate reference systems for 3D data.
...
plot(insc_ch); plot(cities_it, border='red', lwd=2, add = TRUE); plot(c_buff, add = TRUE)
...
### Question: 
*4. What is the ratio of urban to rural inscriptions?* - The urban to rural ratio is 10462 to 1608.
